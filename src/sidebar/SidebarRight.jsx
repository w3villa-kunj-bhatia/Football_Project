  ...
  return (
    <aside className="flex flex-col gap-2">
      ...
      <Card className="p-3">
        ...
        <div className="mb-4 mr-0 overflow-hidden rounded-sm bg-bg p-1">
          <img
          ...
          <div className="py-2">
            <div className="flex justify-between items-start gap-2">
              ...
              <i className="fa-regular fa-bookmark text-lime-400 text-lg shrink-0" />
            </div>
          </div>
        </div>
      ...
      <Card className="p-3">
        ...
        <div className="mb-4 overflow-hidden rounded-sm bg-bg p-1">
          <img
            src="https://images.ctfassets.net/phva2knh4vy5/4N6S2k9K5wzD1fPp9j0HjY/9a55b4f6f1d4e2b8e7a9c4f8e7c8b1d3/podcast-cover.jpg"
